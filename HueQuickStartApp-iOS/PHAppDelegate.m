...
@property (nonatomic, strong) MainViewController *controlLightsViewController;
...
#warning Instert your Gimbal Application API key below in order to see this sample application work
    ...
    MainViewController *controlLightsViewController = [[MainViewController alloc] init];
...
- (void) processRemoteNotification:(NSDictionary *)userInfo
{
    ...
    if (communication)
    {
        [[NSNotificationCenter defaultCenter] postNotificationName:@"PUSH_NOTIFICATION_RECEIVED" object:nil userInfo:@{@"COMMUNICATION": communication}];
    }
}
...
//      Or 5 seconds
//      [self.phHueSDK setLocalHeartbeatInterval:5.0f forResourceType: RESOURCES_LIGHTS];

//       And Remove
//      [self.phHueSDK removeLocalHeartbeatForResourceType:RESOURCES_LIGHTS];
